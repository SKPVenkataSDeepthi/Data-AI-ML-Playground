...
Natural disasters such as hurricanes, earthquakes, and floods severely impact vulnerable communities.
...
💡 **Goal:**  
Use **computer vision** to classify roof materials and estimate structural vulnerability.
...
- 🧠 Train **CNN / Deep Learning models**  
- 🏷️ Classify roof types into categories  
...
- Importance of **high-quality aerial data**
- Handling **class imbalance**
- Model generalization across regions
- Real-world impact of AI in **disaster response**
...
- 🏚️ Predict **building damage risk (not just roof type)**
- ⚡ Deploy as a **real-time API / web app**
...
- World Bank – Resilient Housing Program  
- WeRobotics  
